    ...
    Node(int item)
    {
        ...
        void connect(Node root)
        {
            ...
            while (!q.isEmpty()) {
                ...
                // remove will remove the node from queue
                Node temp = q.remove();
                ...
                if (temp == null) {
                    ...
                    temp.nextRight = q.peek(); // peek will return the next value from queue but it will not remove it and assign that value to the nextright of temp
